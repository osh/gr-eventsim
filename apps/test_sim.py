...
# Title: Test Sim
# Generated: Thu Nov 19 11:23:17 2015
##################################################
...
class test_sim(gr.top_block):
    ...
    def __init__(self, nthreads=8, dps=500, l2=15.0, l1=10.0, ld=4.0):
...
if __name__ == '__main__':
    ...
    parser.add_option("", "--nthreads", dest="nthreads", type="intx", default=8,
    ...
    tb = test_sim(nthreads=options.nthreads, dps=options.dps, l2=options.l2, l1=options.l1, ld=options.ld)
    tb.start()
    tb.wait()
