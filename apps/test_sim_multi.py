...
class test_sim_multi(gr.top_block):
    ...
    def __init__(self, dps=500, l1=10.0, l2=15.0, ld=4.0, nthreads=4):
        ...
        self.es_mulisink_0 = es.multisink(1*[gr.sizeof_gr_complex],2,64,0,2,"", 2)
...
def argument_parser():
    ...
    parser.add_option(
        "", "--nthreads", dest="nthreads", type="intx", default=4,
