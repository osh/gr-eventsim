...
# Generated: Wed Dec 30 18:39:39 2015
##################################################
...
def argument_parser():
    ...
    parser.add_option(
        "", "--nsinks", dest="nsinks", type="intx", default=4,
...
def main(top_block_cls=test_sim_multi, options=None):
    ...
    tb = top_block_cls(l1=options.l1, l2=options.l2, ld=options.ld, nthreads=options.nthreads, dps=options.dps, nsinks=options.nsinks)
    tb.start()
    tb.wait()
